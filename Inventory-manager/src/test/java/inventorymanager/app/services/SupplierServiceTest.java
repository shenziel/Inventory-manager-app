 ...
 * assertThrows(RuntimeException.class, () -> svc.addSupplier(s2),
 * "expected duplicate add to throw");
 * }
 * 
 * @Test
 * 
 ...
 * 
 * Supplier updated = svc.updateSupplier("s1", new Supplier("ignored",
 * "NewName"));
 ...
 * SupplierService svc = new TestSupplierService();
 * assertThrows(RuntimeException.class, () -> svc.updateSupplier("missing", new
 * Supplier("x","y")));
 * }
 * 
 * @Test
 ...
 * assertThrows(IllegalArgumentException.class, () -> svc.updateSupplier(null,
 * new Supplier("x","y")));
 * }
 * }
 * 
